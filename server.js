...
async function applyStatsAndCondition(client,clubId,startersList,conceded,events,result){
  ...
  for(const p of startersList){
    ...
    await client.query(`UPDATE players SET fitness=GREATEST(25,fitness-ROUND($2::numeric)),morale=GREATEST(35,LEAST(100,morale+$3)) WHERE id=$1`,[p.id,fatigue,moraleDelta]);
  }
